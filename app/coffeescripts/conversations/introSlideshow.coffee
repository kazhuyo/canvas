define [
  ...
  ->
    ...
    introSlideshow.addSlide I18n.t('titles.slide1', 'Slide 1'), (slide) ->
      ...
      slide.addParagraph(I18n.t('slide1.paragraph2', 'Conversations—the new messaging system—has arrived!'), 'large')
    ...
    introSlideshow.addSlide I18n.t('titles.slide9', 'Slide 9'), (slide) ->
      slide.addImage('/images/conversations/intro/image9.png', 'screenshot')
      slide.addParagraph(I18n.t('slide9.paragraph1', 'We think you\'ll find Conversations simple and easy to use.'))
      slide.addParagraph(I18n.t('slide9.paragraph2', 'Try all feature inside Conversations now.'))
